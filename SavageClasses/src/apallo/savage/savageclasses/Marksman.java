...
public class Marksman implements Listener
{
    ...
    private Cooldown leapCD;
    private Cooldown arrowToTheKneeCD;
    private Cooldown staticShotCD;
    private Cooldown poisonShotCD;
    private double leapVelocity;
    private double leapYVelocity;
    ...
    private HashSet<String> isLeaping = new HashSet();
    ...
    public void onEntityShootBow(EntityShootBowEvent event)
    {
        ...
        if (SC.isClass(player, "marksman") && SavageUtility.hasLeatherGear(player))
        {
    ...
    public void onPlayerInteract(PlayerInteractEvent event)
    {
        ...
        {
            if (player.getInventory().getItemInMainHand().getType() == Material.BOW && !rotateCD.isOnCooldown(player))
            {
